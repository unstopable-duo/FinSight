...
const startIdx = content.indexOf("{activeTab === 'overview' && dashboard.account?.persona === 'founder' && (");
const endIdx = content.indexOf("{activeTab === 'data' && (");
...
if (startIdx !== -1 && endIdx !== -1) {
    ...
    console.log("Updated App.tsx overview section");
} else {
